...
#define LSM303_ADDRESS_ACCEL          (0x19<<1)//(0x32 >> 1)         // 0011001x (0x19) (0x32>>1) is incorrect?
#define LSM303_ADDRESS_MAG            (0x3C >> 1)         // 0011110x (0x1E)
#define LSM303_ID                     (0b11010100)		// 0xD4
